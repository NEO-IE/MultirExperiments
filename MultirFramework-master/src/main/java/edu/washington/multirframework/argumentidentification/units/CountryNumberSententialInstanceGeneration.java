 ...
 * all the countries and all the numbers found in a sentence
 * The country argument identifier only identifies countries, and the numbers are read separately from a different file
 * @author aman
 *
 */
